...
<div class="content-block-ContentBlock-module-block">
	<div class="content-block-ContentBlock-module-info">
		...
		<p class="content-block-ContentBlock-module-text content-block-ContentBlock-module-text-big content-block-ContentBlock-module-last">
			Для развития необходим новый опыт и готовность использовать передовые технологии, помноженные на желание помогать пациентам. Наш рост и прогресс стал возможен благодаря сотрудничеству с ведущими представителями отрасли здравоохранения.
		</p>
		<div class="content-block-ContentBlock-module-bottom"></div>
	</div>
	<div class="content-block-ContentBlock-module-image">
		<img class="partners-Partners-module-banner" src="/upload/images/static_media/partners/banner.png" alt="banner" />
	</div>
</div>
...
$APPLICATION->IncludeComponent(
	...
	array(
		...
		"ARR_ORDER" => "arr_order",
		"ARR_ELEMENT_ORDER" => "arr_element_order",
