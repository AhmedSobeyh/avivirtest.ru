...
<div class="content-block-ContentBlock-module-block">
	<div class="content-block-ContentBlock-module-info">
		...
		<h2 class="content-block-ContentBlock-module-title content-block-ContentBlock-module-title-big"><?= GetMessage('TITLE') ?></h2>
	...
	<div class="content-block-ContentBlock-module-image">
		<img class="services-Services-module-banner" src="/upload/images/static_media/services/banner.png" alt="<?= GetMessage('TITLE') ?>" />
	</div>
</div>
