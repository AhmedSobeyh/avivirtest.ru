					...
					<div class="c-test-kit-decryption-item__media">
						...
						<picture class="c-picture ">
							<img
								...
								alt="Если линия (С) окрашивается в красный цвет"
							/>
						</picture>
					</div>
				...
				<section class="c-test-kit-decryption-item c-test-kit-decryption__item">
					<div class="c-test-kit-decryption-item__media">
						...
						<picture class="c-picture ">
							<img
								class="c-picture__img c-test-kit-decryption-item__img"
								src="/upload/images/test-kit/test-kit-decryption-ag-c-t-positive.svg"
								alt="Если линия (C) окрашивается в красный цвет а линия (Т) в черный"
							/>
						</picture>
					</div>
					<div class="c-test-kit-decryption-item__body">
				...
				<section class="c-test-kit-decryption-item c-test-kit-decryption__item c-test-kit-decryption__item--span-2">
					<div class="c-test-kit-decryption-item__media">
						...
						<picture class="c-picture ">
							<img
								class="c-picture__img c-test-kit-decryption-item__img"
								src="/upload/images/test-kit/test-kit-decryption-ag-unknown.svg"
								alt="При отсутствии в окошке окрашенной в красный цвет линии (C)"
							/>
						</picture>
					</div>
