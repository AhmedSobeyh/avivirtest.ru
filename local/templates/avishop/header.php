...
<head>
	<? include "init.php"; ?>
	<title><? $APPLICATION->ShowTitle() ?><?/*if (!$isMainPage):?> / <?endif*/ ?><? //=GetMessage('TITLE_POSTFIX')
																					?></title>
	...
	<div id="react-root">
		...
		<div id="react-root">
			<div class="hidden-Hidden-module-mobile-hidden">
				<header class="avishop-Header-module-header" id="header">
					<div class="avishop-Header-module-box">
						<div class="avishop-Header-module-logo"><a href="/">AVISHOP</a></div>
					...
					<div class="avishop-Header-module-box">
						...
						<a href="https://avivir.ru/">
							<button class="button-Button-module-button avishop-Header-module-button">
								Перейти на сайт Avivir.ru
							</button>
						</a>
					</div>
				</header>
					...
					<div class="page-Header-module-action">
						<div class="page-Header-module-number">
							<div class="hidden-Hidden-module-desktop-hidden">
								...
								<a class="page-Header-module-lang" href="https://en.avivir.ru/">en</a>
