...
<footer class="page-Footer-module-footer" id="footer">
	<div class="page-Footer-module-info">
		...
		<nav class="page-Footer-module-links">
			<ul>
				<li><a href="https://avivir.ru/products/">Продукция</a></li>
				<li><a href="https://avivir.ru/services/">Услуги</a></li>
				<li><a href="https://avivir.ru/business/company/">О компании</a></li>
				<li><a href="https://avivir.ru/media/">Медиа-центр</a></li>
				<li><a href="https://shop.avivir.ru/">Avishop</a></li>
				<li><a href="https://avivir.ru/contacts/">Контакты</a></li>
			</ul>
		</nav>
	</div>
	<div class="page-Footer-module-action">
		<a href="https://avivir.ru/contacts/"><button class="button-Button-module-button">Свяжитесь с нами</button></a>
		...
		<p>
			ООО "Авивир", ИНН 5047227711, КПП 504701001,
		</p>
	</div>
	<div class="page-Footer-module-agreement">
		<span><a href="https://avivir.ru/privacy/">Соглашение на обработку персональных данных</a> и<!-- -->
			<a href="https://avivir.ru/documents/">Противодействие коррупции</a></span>
		<a href="https://i.moscow/company/44003695"><img src="/upload/images/static_media/footer/moscow_cluster.png" alt="Московский инновационный кластер" /></a>
	</div>
</footer>
</div>
<? // END: App footer 
