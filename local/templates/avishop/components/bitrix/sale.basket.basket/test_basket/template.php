...
?>
	...
	false
			...
			<div class="content-block-ContentBlock-module-content cart-Cart-module-cart content-block-ContentBlock-module-last">
						...
						<div class="col-xs-12">
							<div class="basket-items-list-wrapper basket-items-list-wrapper-height-fixed basket-items-list-wrapper-light<?= $displayModeClass ?>" id="basket-items-list-wrapper">
								...
								<div class="basket-items-list-container" id="basket-items-list-container">
									...
									<!-- Кастомный код -->
									<div class="cart-Cart-module-top">
										<div class="cart-Cart-module-column-1"></div>
										<div class="cart-Cart-module-column-2">Товар</div>
										<div class="cart-Cart-module-column-3">Цена</div>
										<div class="cart-Cart-module-column-4">Количество</div>
										<div class="cart-Cart-module-column-5">Итого</div>
									</div>
									<!-- Кастомный код -->
