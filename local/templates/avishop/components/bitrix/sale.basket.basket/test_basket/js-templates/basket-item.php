		...
		{{^SHOW_RESTORE}}
			<td class="basket-items-list-item-descriptions">
				<div class="basket-items-list-item-descriptions-inner" id="basket-item-height-aligner-{{ID}}">
					...
					{
						?>
						<div class="basket-item-block-image<?=(!isset($mobileColumns['PREVIEW_PICTURE']) ? ' ' : '')?> cart-Cart-module-column-1">
							{{#DETAIL_PAGE_URL}}
							...
							{{#SHOW_LABEL}}
								<div class="basket-item-label-text basket-item-label-big <?=$labelPositionClass?>">
									{{#LABEL_VALUES}}
										<div{{#HIDE_MOBILE}} class=""{{/HIDE_MOBILE}}>
					...
					?>
					<div class="basket-item-block-info cart-Cart-module-column-2">
						<?
			...
			{
				?>
				<td class="basket-items-list-item-price basket-items-list-item-price-for-one<?=(!isset($mobileColumns['PRICE']) ? ' ' : '')?>">
					<div class="basket-item-block-price cart-Cart-module-column-3">
						{{#SHOW_DISCOUNT_PRICE}}
			...
			<td class="basket-items-list-item-amount">
				<div class="basket-item-block-amount{{#NOT_AVAILABLE}} disabled{{/NOT_AVAILABLE}} cart-Cart-module-column-4"
			...
			{
				?>
				<td class="basket-items-list-item-price<?=(!isset($mobileColumns['SUM']) ? ' ' : '')?> ">
					<div class="basket-item-block-price cart-Cart-module-column-5">
						{{#SHOW_DISCOUNT_PRICE}}
							<div class="basket-item-price-old">
