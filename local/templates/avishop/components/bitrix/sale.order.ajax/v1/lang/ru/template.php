...
$MESS["SOA_INVALID_TEL"] = "Введен неверный телефон";
...
$MESS["SOA_ORDER_SUC"] = "Здравствуйте!<br><br>Ваш заказ на сайте Avishop создан.<br><br>Номер вашего заказа: <b>#ORDER_ID#</b><br><br>Состав заказа:<br>";
$MESS["SOA_PAYMENT_SUC"] = ""; 
$MESS["SOA_ORDER_SUC1"] = "Информация о статусе заказа будет приходить вам на почту, указанную при оформлении заказа.";
