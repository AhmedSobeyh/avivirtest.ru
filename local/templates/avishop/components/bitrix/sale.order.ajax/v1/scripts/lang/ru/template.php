...
$MESS["SOA_ORDER_SUC"] = "Здравствуйте!<br>Ваш заказ на сайте Avishop создан.<br>Номер вашего заказа:<b>#ORDER_ID#</b><br>Состав заказа: <br>#ORDER_LIST#<br>Информация о статусе заказа будет приходить вам на почту, указанную при оформлении заказа."; 
