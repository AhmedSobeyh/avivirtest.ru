				...
				<div id="bx-soa-orderSave">
					...
					<div class="col-sm-12 bx-soa-pp-item-container">
						<div class="bx-soa-pp-company bx-soa-pp-company-item col-lg-4 col-sm-4 col-xs-6">
							...
							<div class="bx-soa-pp-company-smalltitle" lang="ru">Я согласен на обработку персональных данных</div>
						</div>
					</div>
					...
					<div class="col-sm-12 bx-soa-pp-item-container">
						<div class="bx-soa-pp-company bx-soa-pp-company-item col-lg-4 col-sm-4 col-xs-6">
							...
							<div class="bx-soa-pp-company-smalltitle" lang="ru">Согласен с публичной офертой</div>
						</div>
					</div>

					<div class="bx-custom-buttons">
						<a href="javascript:void(0)" style="margin: 10px 0" class="btn btn-default btn-lg " data-save-button="true">
							<?=$arParams['MESS_ORDER']?>
						</a>
