...
<main class="c-literature-list-page">
	<div class="c-literature-list-page__section-navbar">
	...
	<div class="c-literature-list-page__literature-list">
		...
		$APPLICATION->IncludeComponent(
			...
			Array(
				...
				"PROPERTY_CODE" => ["PERSONA", "DATE"],
				"FIELD_CODE" => ["DETAIL_PICTURE","PREVIEW_PICTURE"],
				"SHOW_SUBNAV" => "N"
			),
			$component
		);
