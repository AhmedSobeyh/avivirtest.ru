...
<?$GLOBALS["m_filter"] = array(
	"!ID" => $ElementID
);

if (!empty($arParams["FILTER_NAME"]) && count($GLOBALS[$arParams["FILTER_NAME"]]) > 0)
{
	$GLOBALS["m_filter"] = array_merge($GLOBALS["m_filter"], $GLOBALS[$arParams["FILTER_NAME"]]);
}
