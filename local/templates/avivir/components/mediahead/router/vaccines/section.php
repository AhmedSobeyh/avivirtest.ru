...
if ( LANGUAGE_ID == 'ru' )
{
	$sectName = $section['NAME'].' / Авивир';
	$sectTitle = $section['NAME'].' | Авивир';
	$sectDescription = '';
}
else
{
	$sectName = $section['UF_EN_NAME'].' / Avivir';
	$sectTitle = $section['UF_EN_NAME'].' | Avivir';
	$sectDescription = '';
}
...
<?// START: App header ?>
<header class="c-app-header c-app-header--density-compact">
...
<main class="o-main">
	<div class="o-main__wrap">
		...
		// На всякий оставил, т.к. логика похожая
		$APPLICATION->IncludeComponent(
