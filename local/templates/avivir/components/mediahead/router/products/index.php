...
<?// START: App header ?>
<header class="c-app-header c-app-header--density-compact c-app-header--fullscreen t-dark u-bg-secondary-darken-3 c-catalog-page-app-header">
	<div class="o-container@lg c-app-header__container">
		...
		<div class="c-app-header__layout">
			<div class="c-app-header__body">
				...
				<div class="c-catalog-page-app-header__catalog-section-card-list">
					<? $APPLICATION->IncludeComponent(
						"mediahead:section.list",
						"catalog-section-card-list",
						Array(
							"IBLOCK_TYPE" => $arParams["IBLOCK_TYPE"],
							"IBLOCK_ID" => $arParams["IBLOCK_ID"],
							"COUNT_ELEMENTS" => "4",
							"SECTION_FIELDS" => [0 => "NAME", "DESCRIPTION", "PICTURE"],
							"SECTION_USER_FIELDS" => [0 => "UF_EN_NAME", "UF_EN_DESCRIPTION", "UF_SVG"],
