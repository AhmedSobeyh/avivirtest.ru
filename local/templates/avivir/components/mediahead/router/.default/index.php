		...
		>
			<div class="c-catalog-test-page-header__layout">
				...
				<div class="c-catalog-test-page-header__body">
					...
					// Это компонент с карточками разделов
					// Карточки должны вести на якорные ссылки на этой же странице ниже
					$APPLICATION->IncludeComponent(
						...
						Array(
							...
							"SECTION_USER_FIELDS" => [0 => "UF_EN_NAME", "UF_EN_DESCRIPTION"],
