...
switch ($arResult['ID']) {
    case 45: $targetPrefix = 'SGTi-flex'; break;
    case 36: $targetPrefix = 'NowCheck'; break;
}
            ...
            <div class="c-app-header__body">
                ...
                <div class="c-app-header__btn-group">
                    ...
                    <a
                        ...
                        onclick="clickButtonToForm('<?=GetMessage('MD_CALC_ORDER')?>'); <?=ym('Consultation', $targetPrefix)?>"
                    >
                            ...
                            <div class="c-feature-item c-feature-item--column">
                                ...
                                <div class="c-feature-item__body">
                                    ...
                                    <p class="c-feature-item__title">
                                        <a class="c-feature-item__link" href="<?=$arResult['BRAND']['DETAIL_PAGE_URL']?>" target="_blank"><?=$arResult['BRAND']['NAME']?></a>
                                    </p>
                                </div>
                            </div>
                            <?// END: Feature item ?>
                            ...
                            <div class="c-test-kit-detail__btn-group">
                                <?if ($arResult['PROPERTIES']['INSTRUCTION']['VALUE']):?>
                                    ...
                                    <a
                                        ...
                                        <?=ym('Download_instruction', $targetPrefix, true)?>
                                    >
									<span
                                ...
                                <?if ($arResult['REGDOCS']):?>
                                    <button
                                        ...
                                        <?=ym('Registration_documents', $targetPrefix, true)?>
                                    >
									<span
                                        class="c-btn__overlay"
                                    ></span>
                                ...
                                <?if ($arResult['PROPERTIES']['PRESENTATION']['DISPLAY']):?>
									...
									"
                                        <?=ym('Presentation', $targetPrefix, true)?>
                                    >
                                        <span class="c-btn__overlay"></span>
                        ...
                        <div class="c-test-kit-partner-action__body">
                            <ul class="c-test-kit-partner-action__list">
                                <?foreach($arResult['RETAIL'] as $retail):
                                    $action = '';
                                    switch ($retail['ID']) {
                                        case 124: //Pharm Retail
                                            $action = 'PharmRetail';
                                            break;
                                        case 38: //Pharm Retail
                                            $action = 'SBER';
                                            break;
                                        case 92: //Pharm Retail
                                            $action = 'Bosco';
                                            break;
                                    }
                                    ?>
