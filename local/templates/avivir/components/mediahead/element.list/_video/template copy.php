	...
	<div class="o-container@md c-video-list__container">
		<ul class="c-video-list__layout">
			...
			<?foreach($arResult["VIDEO"] as $arItem):?>
				...
				<li class="c-video-list__item" id="<?=$this->GetEditAreaId($arItem['ID']);?>">
					<div class="c-video-list-item">
						<div class="o-embed-responsive o-embed-responsive--16by9 c-video-list-item__media">
							<video class="o-embed-responsive__item" poster="<?=$arItem['POSTER']?>" preload="true" controls playsinline webkit-playsinline>
